...
(function ($) {
  ...
  ploneFormTabbing.initializeForm = function () {
    ...
    $(this)
      .find(".formPanel:has(div.field span.required)")
      .each(function () {
    ...
    jqForm
      .children(tabSelector)
      .tabs(jqForm.children("fieldset.formPanel"), tabsConfig);
    ...
    $(
      "div.formControls input[name='form.button.previous']," +
        "div.formControls input[name='form.button.next']"
    ).remove();
  };
  ...
  $.fn.ploneTabInit = function (pbo) {
    return this.each(function () {
      ...
      item
        .find("form.enableFormTabbing,div.enableFormTabbing")
      ...
      var targetPane =
        item.find('.enableFormTabbing input[name="fieldset"]').val() ||
        window.location.hash;
      if (targetPane) {
        item
          .find(
            '.enableFormTabbing .formTabs [id="' +
              targetPane
                .replace("#", "")
                .replace('"', "")
                .replace(/^fieldset-/, "fieldsetlegend-") +
              '"]'
          )
          .click();
      }
