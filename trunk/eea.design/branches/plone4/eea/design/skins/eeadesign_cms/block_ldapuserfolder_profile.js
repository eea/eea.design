...
$(document).ready(function () {
    ...
    if (LDAPUserFolder_control) {
        ...
        LDAPUserFolder_configlet.append('<label style="color:red">Profile for LDAP User Folder was disabled as it is meant for pure CMF sites only and will break Plone.</label>');
    }
});
